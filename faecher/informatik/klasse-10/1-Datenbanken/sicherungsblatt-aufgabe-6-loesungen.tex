...
\textcolor{Blue}{\bfseries Vom Filtern zum Verbinden:} Die Salat- und Pizza-Bedingungen filtern nach einem Wert. Eine Verknüpfungsbedingung vergleicht passende Attribute zweier Tabellen, zum Beispiel \texttt{photos.user\_id = users.id}.\vspace{1.3mm}}}

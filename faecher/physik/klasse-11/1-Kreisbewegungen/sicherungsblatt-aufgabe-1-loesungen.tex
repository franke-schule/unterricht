...
\begin{minipage}[t]{0.35\linewidth}
  ...
  \begin{tikzpicture}[>=Latex, node distance=13mm, every node/.style={font=\small\bfseries}]
    \node (ms) {$1\unitfrac{m}{s}$};
    \node[right=31mm of ms] (kmh) {$3{,}6\unitfrac{km}{h}$};
...
\begin{minipage}[t]{0.61\linewidth}
  ...
  \begin{tabularx}{\linewidth}{@{}>{\bfseries}l>{\centering\arraybackslash}X>{\centering\arraybackslash}X@{}}
    ...
    $5{,}0\unitfrac{km}{h}$ & $: 3{,}6$ & $\approx 1{,}4\unitfrac{m}{s}$ \\
    $5{,}4\unitfrac{m}{s}$ & $\times 3{,}6$ & $\approx 19\unitfrac{km}{h}$ \\
    $60\unitfrac{km}{h}$ & $: 3{,}6$ & $16{,}666\ldots\unitfrac{m}{s}\approx16{,}7\unitfrac{m}{s}$ \\
    $36\unitfrac{m}{s}$ & $\times 3{,}6$ & $129{,}6\unitfrac{km}{h}\approx130\unitfrac{km}{h}$
  \end{tabularx}
\end{minipage}
...
\begin{tabularx}{\linewidth}{@{}>{\bfseries}p{18mm}X@{}}
  Gegeben: & $a=2{,}5\unitfrac{m}{s^{2}}$, $t=3{,}0\unit{s}$; der Körper befindet sich zu Beginn in Ruhe, also $v_{0}=0\unitfrac{m}{s}$. \\
  Gesucht: & $v(t=3{,}0\unit{s})$ \\
  Ansatz: & $v=a\cdot t+v_{0}$ \\
  Rechnung: & $v=0\unitfrac{m}{s}+2{,}5\unitfrac{m}{s^{2}}\cdot3{,}0\unit{s}=7{,}5\unitfrac{m}{s}=27\unitfrac{km}{h}$
\end{tabularx}
...
\begin{tikzpicture}[x=1.12cm,y=.15cm,>=Latex,font=\scriptsize]
  ...
  \draw[->,Muted] (0,0)--(0,29) node[above] {$v$ in $\frac{\mathrm{m}}{\mathrm{s}}$};
...
\begin{tabularx}{\linewidth}{@{}>{\centering\arraybackslash}p{9mm}>{\raggedright\arraybackslash}X>{\raggedleft\arraybackslash}p{34mm}@{}}
  ...
  I & gleichmäßig beschleunigt ($0\unitfrac{m}{s}\rightarrow15\unitfrac{m}{s}$) & $a_{\mathrm{I}}\approx 0{,}083\unitfrac{m}{s^{2}}$ \\
  II & gleichförmig ($v=15\unitfrac{m}{s}$) & $a_{\mathrm{II}}=0\unitfrac{m}{s^{2}}$ \\
  III & gleichmäßig beschleunigt ($15\unitfrac{m}{s}\rightarrow25\unitfrac{m}{s}$) & $a_{\mathrm{III}}\approx 0{,}056\unitfrac{m}{s^{2}}$ \\
  IV & gleichförmig ($v=25\unitfrac{m}{s}$) & $a_{\mathrm{IV}}=0\unitfrac{m}{s^{2}}$ \\
  V & gleichmäßig verzögert ($25\unitfrac{m}{s}\rightarrow0\unitfrac{m}{s}$) & $a_{\mathrm{V}}\approx -0{,}14\unitfrac{m}{s^{2}}$
\end{tabularx}

\vspace{1.2mm}
\colorbox{Mint}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{\raggedright
  \vspace{0.8mm}\textcolor{Blue}{\bfseries Weg aus dem $v(t)$-Diagramm}\par
  \textbf{Weg $=$ Fläche unter dem Graphen.} Fläche in Dreiecke
  \mbox{$\bigl(A=\tfrac{1}{2}\cdot g\cdot h\bigr)$} und Rechtecke
  \mbox{$(A=a\cdot b)$} zerlegen, Teilflächen addieren.
  \vspace{0.8mm}}}
\end{minipage}
\vspace{0.6mm}
\colorbox{Mint}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{\small%
  \vspace{0.8mm}\textbf{Ansatz:}\enspace
  $s=\tfrac{1}{2}\cdot180\,\mathrm{s}\cdot15\,\mathrm{\tfrac{m}{s}}
  +180\,\mathrm{s}\cdot15\,\mathrm{\tfrac{m}{s}}
  +\bigl(180\,\mathrm{s}\cdot15\,\mathrm{\tfrac{m}{s}}+\tfrac{1}{2}\cdot180\,\mathrm{s}\cdot10\,\mathrm{\tfrac{m}{s}}\bigr)
  +180\,\mathrm{s}\cdot25\,\mathrm{\tfrac{m}{s}}
  +\tfrac{1}{2}\cdot180\,\mathrm{s}\cdot25\,\mathrm{\tfrac{m}{s}}$\hfill{\scriptsize $3\,\mathrm{min}=180\,\mathrm{s}$}\vspace{0.8mm}}}

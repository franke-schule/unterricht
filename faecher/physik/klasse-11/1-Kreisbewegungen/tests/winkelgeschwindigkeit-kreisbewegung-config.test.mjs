...
assert.match(html, /ω in <span class="physics-fraction" role="img" aria-label="Radiant pro Sekunde">/);
...
assert.match(html, /data-angle-action="restart">Neustarten</);
assert.doesNotMatch(html, /data-angle-action="(start|reset)"/);
assert.match(html, /id="angle-quiz"/);
assert.match(source, /correct: \["time-larger", "angle-smaller"\]/);
assert.match(source, /desto \*\*größer\*\* die Winkelgeschwindigkeit/);
...
assert.match(source, /createIndexedSymbol\("v", "B"\)/);

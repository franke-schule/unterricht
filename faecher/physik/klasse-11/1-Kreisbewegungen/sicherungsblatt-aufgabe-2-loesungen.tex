...
\textcolor{Blue}{\bfseries Beispiel aus Teilaufgabe 3}\par\vspace{0.35mm}
...
\vspace{0.25mm}{\small $m=0{,}100\unit{kg}$ sind drei gültige Ziffern. $F=1{,}2\unit{N}$ sind zwei gültige Ziffern. Daher wird das Endergebnis mit zwei gültigen Ziffern angegeben.}
\end{tcolorbox}
...
\begin{tikzpicture}[x=.8mm,y=.62mm,>=Latex]
  \draw[fill=Sky,draw=Blue] (0,5) .. controls (10,18) and (30,18) .. (40,5) -- cycle;
  % Springer: Hände an den Leinen, Kraftpfeile gleich lang (F_R = F_G).
  \draw[Line] (5,7)--(16.5,-1) (35,7)--(23.5,-1);
  \draw[Navy,line width=.6pt,line cap=round,line join=round]
    (16.5,-1)--(20,-4.5)--(23.5,-1)
    (18.3,-17)--(19.2,-10) (21.7,-17)--(20.8,-10);
  \draw[fill=Mint,draw=Navy,line width=.45pt,rounded corners=.5mm] (18.6,-3.6) rectangle (21.4,-10.4);
  \draw[fill=Mint,draw=Navy,line width=.45pt] (20,-0.4) circle[radius=1mm];
  \draw[-{Latex},Blue,line width=.7pt] (20,-6.5)--(20,17) node[above,font=\scriptsize] {Luftwiderstandskraft $F_R$};
  \draw[-{Latex},Blue,line width=.7pt] (20,-6.5)--(20,-30) node[below,font=\scriptsize] {Gewichtskraft $F_G$};
  \fill[Blue] (20,-6.5) circle[radius=.55mm];
  \node[font=\scriptsize] at (20,-38) {$F_R=F_G$};
\end{tikzpicture}
&\centering\textbf{Körper auf dem Tisch}\par
\begin{tikzpicture}[x=.8mm,y=.62mm,>=Latex]
  \draw[fill=Sky,draw=Blue] (5,-10) rectangle (35,-7); \draw[Blue] (10,-7)--(10,-13) (30,-7)--(30,-13); \draw[fill=Mint,draw=Blue] (14,-7) rectangle (26,1);
  % Gleich lange Pfeile; die Tischkraft greift leicht versetzt an der Auflagefläche an, damit sich die Pfeile nicht überdecken.
  \draw[-{Latex},Blue,line width=.7pt] (22,-7)--(22,15) node[above,font=\scriptsize,align=center] {Kraft des Tisches\\auf den Körper};
  \draw[-{Latex},Crack,line width=.7pt] (20,-3)--(20,-25) node[below,font=\scriptsize] {Gewichtskraft};
  \fill[Crack] (20,-3) circle[radius=.55mm];
  \fill[Blue] (22,-7) circle[radius=.55mm];
\end{tikzpicture}
&\centering\textbf{Auto}\par\scriptsize fährt mit konstanter Geschwindigkeit\par
\begin{tikzpicture}[x=.8mm,y=.62mm,>=Latex]
  ...
  \node[font=\scriptsize,align=center] at (33,12) {Kraft durch\\Motor $F_M$};
  \node[font=\scriptsize,align=center] at (7,-12) {Reibungs-\\kraft};
\end{tikzpicture}
\end{tabularx}
\vspace{0.8mm}
{\centering\color{Blue}\bfseries Kräftegleichgewicht -- zwei Kräfte wirken auf denselben Körper\par}
\vspace{1.4mm}
...
\begin{tikzpicture}[x=.75mm,y=.68mm,>=Latex]
  % Das Auto ist in die Mauer gefahren: Die Front steht an der Wandfläche und
  % ist eingedrückt, die Bruchlinien zeigen den Schaden.
  \draw[fill=Muted!25,draw=Navy,line width=.5pt] (4,-10) rectangle (16,10);
  \draw[fill=Sky,draw=Blue] (16,-6)--(20,-3)--(16.5,0)--(21,2.5)--(18,5)--(42,5)--(49,-6)--cycle;
  \draw[Blue] (27,-6) circle (2) (42,-6) circle (2);
  \draw[Crack,line width=.8pt,line cap=round,line join=round] (18.5,6)--(21.5,8)--(19.5,10.5);
  \draw[Crack,line width=.8pt,line cap=round,line join=round] (20.5,-7.5)--(17.5,-9)--(20.5,-11);
  \fill[Gold] (16,0) circle (1.5);
  \draw[-{Latex},Blue,line width=.9pt] (16,0)--(5,0);
  \draw[-{Latex},Blue,line width=.9pt] (16,0)--(29,0);
  \node[font=\scriptsize,align=center] at (3,15) {Kraft des Autos\\auf die Wand};
  \node[font=\scriptsize,align=center] at (33,15) {Kraft der Wand\\auf das Auto};
  \node[font=\scriptsize,below] at (16,-13) {Kontaktpunkt};
\end{tikzpicture}
...
\end{tcolorbox}
\vspace{0.8mm}
{\centering\color{Blue}\bfseries Wechselwirkung -- zwei Kräfte wirken auf unterschiedliche Körper\par}
\end{minipage}

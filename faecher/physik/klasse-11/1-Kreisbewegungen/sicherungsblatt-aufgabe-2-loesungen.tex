...
\begin{tikzpicture}[x=.8mm,y=.62mm,>=Latex]
  ...
  \draw[Line] (5,7)--(16,0) (35,7)--(24,0); \draw[Blue] (20,-1) circle (2); \draw[Blue] (20,-1)--(20,-11);
  \draw[-{Latex},Blue,line width=.7pt] (20,-1)--(20,17) node[above,font=\scriptsize] {Luftwiderstandskraft $F_R$};
  \draw[-{Latex},Blue,line width=.7pt] (20,-1)--(20,-13) node[below,font=\scriptsize] {Gewichtskraft $F_G$};
  \fill[Blue] (20,-1) circle (1.15);
  \node[font=\scriptsize] at (20,-21) {$F_R=F_G$};
\end{tikzpicture}
...
\begin{tikzpicture}[x=.8mm,y=.62mm,>=Latex]
  ...
  \draw[-{Latex},Blue,line width=.7pt] (20,-7)--(20,16) node[above,font=\scriptsize,align=center] {Kraft des Tisches\\auf den Körper};
  \draw[-{Latex},Blue,line width=.7pt] (20,-3)--(20,-16) node[below,font=\scriptsize] {Gewichtskraft};
  \fill[Blue] (20,-3) circle (1.15);
  \fill[Gold] (20,-7) circle (1.5); \draw[Navy,line width=.25pt] (20,-7) circle (1.5);
\end{tikzpicture}

...
\newcommand{\pagefooter}[1]{\vfill{\color{Line}\rule{\linewidth}{0.5pt}}\par\vspace{1mm}\begin{tabularx}{\linewidth}{@{}Xc r@{}}{\small\color{Muted}Klasse 11 · Physik · Kreisbewegungen} & {\small\color{Muted}#1 / 2} & {\small\color{Muted}Sicherungsblatt · Aufgabe 3}\end{tabularx}}
...
\vspace{1.6mm}
{\color{Navy}\fontsize{15}{18}\selectfont\bfseries Aufgabe 3 -- Die Haftreibungskraft als Zentripetalkraft\par}
\vspace{0.9mm}

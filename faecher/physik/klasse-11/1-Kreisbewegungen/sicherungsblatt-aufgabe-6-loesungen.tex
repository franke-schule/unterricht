...
\newcommand{\pagefooter}[1]{\vfill{\color{Line}\rule{\linewidth}{0.5pt}}\par\vspace{1mm}\begin{tabularx}{\linewidth}{@{}Xc r@{}}{\small\color{Muted}Klasse 11 · Physik · Kreisbewegungen} & {\small\color{Muted}#1} & {\small\color{Muted}Sicherungsblatt · Aufgabe 6}\end{tabularx}}
...
\vspace{1.6mm}
{\color{Navy}\fontsize{15}{18}\selectfont\bfseries Aufgabe 6 -- Kräfte beim Kettenkarussell\par}
\vspace{0.9mm}
...
\small\textbf{Musterlösung Teilaufgabe 2:} $m=50\unit{kg}+65\unit{kg}=115\unit{kg}$; $r=6{,}0\unit{m}$ (Kreis von Gondel und Person, \textbf{nicht} $5{,}0\unit{m}$); $T=9{,}0\unit{s}$.
\[
...
\sectiontitle{2 · Kräfteparallelogramm beim Kettenkarussell}
...
\sectiontitle{3 · Musterlösungen: Beschreiben und Erläutern}
\small
...
\par\vspace{1mm}
\sectiontitle{4 · Kräfte einzeichnen (Teilaufgabe 6)}
\begin{minipage}[c]{0.44\linewidth}\centering
\begin{tikzpicture}[x=1.0mm,y=1.0mm,>=Latex]
